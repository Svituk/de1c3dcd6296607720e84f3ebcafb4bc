...
echo "<a class='apicms_menu_s' href='/modules/all_news.php' > <strong><img src='/design/styles/".htmlspecialchars($api_design)."/menu/news.png' alt=''> Новости <span style='float:right'> <small>".$k_p_news." ".$k_n_news."</small> </span></strong></a>";
////////////////////////////////////////
...
echo "<a class='apicms_menu_s' href='/mini_chat/' > <strong><img src='/design/styles/".htmlspecialchars($api_design)."/menu/mini.png' alt=''> Мини-чат <span style='float:right'> <small>".$k_p_chat." ".$k_n_chat."</small> </span></strong></a>";
////////////////////////////////////////
...
echo "<a class='apicms_menu_s' href='/guest/' > <strong><img src='/design/styles/".htmlspecialchars($api_design)."/menu/guest.png' alt=''> Гостевая <span style='float:right'> <small>".$k_p_guest_t." ".$k_n_guest_t."</small> </span></strong></a>";
////////////////////////////////////////
...
echo "<a class='apicms_menu_s' href='/api_forum/' > <strong><img src='/design/styles/".htmlspecialchars($api_design)."/menu/forum.png' alt=''> Форум <span style='float:right'> <small>".$k_p_forum_t." ".$k_n_forum_t." / ".$k_p_forum_p." ".$k_n_forum_p."</small> </span></strong></a>";
...
echo "<a class='apicms_menu_s' href='/api_lib/' > <strong><img src='/design/styles/".htmlspecialchars($api_design)."/menu/library.png' alt=''> Библиотека <span style='float:right'> <small>".$k_p_lib_t." ".$k_n_lib_t." / ".$k_p_lib_p." ".$k_n_lib_p."</small> </span></strong></a>";
