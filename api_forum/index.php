...
echo '<div class="apicms_subhead"><table width="100%" ><tr><td width="10%"><center><img src="/design/styles/'.display_html($api_design).'/forum/razdel.png">';
echo "</center></td><td width='90%'>";
if ($user_level==1 || $user_level==2) echo ' <a href="delete_razdel.php?id='.$post_forum['id'].'"><img src="/design/styles/'.display_html($api_design).'/forum/del_theme.png"></a> ';
echo "<a href='subforum.php?id=$post_forum[id]'><b>".display_html($post_forum['name'])."  </b></a> ";
echo "<span style='float:right'> <small>".apicms_data($post_forum['time'])."</span> </br>";
if ($post_forum['opisanie']!=NULL)echo ''.display_html($post_forum['opisanie']).'';
