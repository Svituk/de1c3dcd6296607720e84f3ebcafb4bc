...
if (!empty($user) && isset($user['level']) && ($user['level']==1 || $user['level']==2)) echo ' <a href="delete_cat.php?id='.$post_lib['id'].'"><img src="/design/styles/'.htmlspecialchars($api_design).'/lib/del_cat.png"></a> ';
