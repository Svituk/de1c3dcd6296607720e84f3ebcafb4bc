...
$ban_reason = $ban_row ? $ban_row['prich'] : '';
echo '<div class="apicms_content">';
echo '<center> <img src="/design/styles/'.htmlspecialchars($api_design).'/images/ban.png" alt=""> </br> <strong>Ваш профиль заблокирован администрацией нашего сайта до '.apicms_data($user['block_time']).'</strong></br>'.($ban_reason!=='' ? '<br/>Причина: <b>'.$ban_reason.'</b>' : '').'</center>';
echo '</div>';
