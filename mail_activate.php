...
echo '<div class="apicms_subhead"><center><strong><img src="/design/styles/'.htmlspecialchars($api_design).'/images/no_act_mail.png" alt=""> </center></div><div class="erors"> Система APICMS ожидает активацию почты, если вам не пришло письмо с кодом активации пожалуйста обратитесь в службу поддержки данного сайта или на e-mail администратора '.$api_settings['adm_mail'].'</strong></br></div>';
}else{
