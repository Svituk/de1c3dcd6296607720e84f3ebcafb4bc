...
/////////////////////////////////////////
header('apicms_content-type: application/rss+xml');
...
echo '<item><title>News: '.htmlspecialchars($api_rss['name']).'</title>';
echo '<link>'.$set['site'].'/modules/news.php</link>';
echo '<author>'.htmlspecialchars($ank['login']).'</author>';
echo '<description>'.htmlspecialchars($api_rss['txt']).'</description>';
