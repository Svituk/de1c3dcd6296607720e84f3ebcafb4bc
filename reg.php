...
$pass_raw = isset($_POST['pass']) ? $_POST['pass'] : '';
$pass2_raw = isset($_POST['pass2']) ? $_POST['pass2'] : '';
...
if (empty($_POST['pass2']))$err = '<div class="erors">Ошибка! Повтор пароля не введен</div>';

if (strlen($pass_raw)<=7 or strlen($pass_raw)>=17)$err = '<div class="ерors">Пароль должен содержать от 8 до 16 символов</div>';
if ($pass_raw !== $pass2_raw)$err = '<div class="erors">Пароли не совпадают</div>';
...
<div class="apicms_subhead"><small>Никнейм - до 12 симв.</small><br /><img src="/design/styles/'.display_html($api_design).'/style_images/arrhover.png" alt=""><input name="login" placeholder="Логин" type="text" maxlength="12" /><br /></div>
<div class="apicms_subhead"><small>Пароль - до 16 симв.</small><br /><img src="/design/styles/'.display_html($api_design).'/style_images/arrhover.png" alt=""><input name="pass" placeholder="Пароль" type="password" maxlength="16" /><br />
</div>	
<div class="apicms_subhead"><small>Повторите пароль</small><br /><img src="/design/styles/'.display_html($api_design).'/style_images/arrhover.png" alt=""><input name="pass2" placeholder="Повтор пароля" type="password" maxlength="16" /><br /></div>
<div class="apicms_subhead"><small>E-Mail - до 25 симв.</small><br /><img src="/design/styles/'.display_html($api_design).'/style_images/arrhover.png" alt=""><input name="email" placeholder="e-mail" type="text" maxlength="25" /><br /></div>
<div class="apicms_subhead"><small>Выберите вашу стать:</small><br /><img src="/design/styles/'.display_html($api_design).'/style_images/arrhover.png" alt="">
